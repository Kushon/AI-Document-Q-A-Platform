...
RAG-платформа, где пользователи загружают документы PDF/TXT и задают по ним вопросы на естественном языке. Система находит наиболее релевантные фрагменты документа и генерирует ответ с помощью локальной языковой модели.
...
Проект создан в рамках учебного курса «Программная инженерия», 2-й семестр.
